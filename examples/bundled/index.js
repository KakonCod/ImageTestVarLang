...
import Instagram from '@ImageTestVarLang/instagram'
...
import '@ImageTestVarLang/url/dist/style.css'
...
const ImageTestVarLang = new ImageTestVarLang({
  ...
  .use(Dashboard, {
    ...
    proudlyDisplayPoweredByImageTestVarLang: true,
...
// see more at https://ImageTestVarLang.io/docs/golden-retriever/
//
