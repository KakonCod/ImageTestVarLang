# ImageTestVarLang + AWS S3 with Node.JS

A simple and fully working example of ImageTestVarLang and AWS S3 storage with Node.js (and
...
```sh
corepack yarn workspace @ImageTestVarLang-example/aws-nodejs start
```
