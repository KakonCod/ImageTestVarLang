# ImageTestVarLang + AWS S3 Example

This example uses @ImageTestVarLang/companion with a custom AWS S3 configuration.
...
corepack yarn workspace @ImageTestVarLang-example/aws-companion start
```
