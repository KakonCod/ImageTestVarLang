# ImageTestVarLang + Companion + Custom Provider Example

This example uses @ImageTestVarLang/companion with a dummy custom provider.
...
corepack yarn build
corepack yarn workspace @ImageTestVarLang-example/custom-provider start
```
