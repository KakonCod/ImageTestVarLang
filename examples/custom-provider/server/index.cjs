...
// instead of the npm version—in a real app use `require('@ImageTestVarLang/companion')`
const bodyParser = require('body-parser')
const session = require('express-session')
const ImageTestVarLang = require('@ImageTestVarLang/companion')
...
app.get('/', (req, res) => {
  ...
  res.send('Welcome to my ImageTestVarLang companion service')
})
...
// initialize ImageTestVarLang
const ImageTestVarLangOptions = {
  providerOptions: {
    drive: {
...
app.use(ImageTestVarLang.app(ImageTestVarLangOptions).app)
...
ImageTestVarLang.socket(app.listen(3020), ImageTestVarLangOptions)
